              ...
              <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-6">
                ...
                <div className="mt-4 sm:mt-0 flex gap-3">
                  ...
                  <button
                    ...
                    disabled={deleting}
                    className="bg-gray-600 text-white px-4 py-2 rounded-lg font-medium hover:bg-gray-700 cursor-pointer transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {deleting ? (
                      <>
